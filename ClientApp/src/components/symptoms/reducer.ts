...
type KnownAction = SymptomsRequestAction | SymptomsRequestSuccessAction | SymptomsRequestErrorAction
    | ChangeSymptomsRequestAction | ChangeSymptomsRequestSuccessAction | ChangeSymptomsRequestErrorAction
    | DeleteSymptomsRequestAction | DeleteSymptomsRequestSuccessAction | DeleteSymptomsRequestErrorAction
...
export const actionCreators = {
    GetSymptoms: (): AppThunkAction<SymptomsRequestAction | SymptomsRequestSuccessAction | SymptomsRequestErrorAction> => (dispatch, getState) => {
    ...
    ChangeSymptoms: (editList: Symptom[]): AppThunkAction<ChangeSymptomsRequestAction | ChangeSymptomsRequestSuccessAction | ChangeSymptomsRequestErrorAction> => (dispatch, getState) => {
    ...
    DeleteSymptoms: (deleteList: { SymptomId: number }[]): AppThunkAction<DeleteSymptomsRequestAction | DeleteSymptomsRequestSuccessAction | DeleteSymptomsRequestErrorAction> => (dispatch, getState) => {
...
export const reducer: Reducer<SymptomsState> = (state: SymptomsState, action: KnownAction) => {
    switch (action.type) {
        ...
        case 'ADD_NEW_SYMPTOM':
            ...
            return {
                ...state,
                Symptoms: [action.symptom, ...symptomsWithoutEmptyName]
            };
        ...
        case 'DELETE_SYMPTOM':
            const symptoms = state.Symptoms.filter(item => item.SymptomId === action.symptomId ? false : true);
            return {
                ...state,
                Symptoms: symptoms
            };
